...
```{r figure-1, fig.width=11, fig.height=5, fig.cap="Venn Euler diagrams showing the overlap in explained variance between attitude, self-identity, and intention. In the diagram on the left, the importance scale is left our of their operationalisation; in the dirgam on the right, it is included."}
fig1 <-
