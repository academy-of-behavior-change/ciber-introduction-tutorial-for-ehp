...
```{r figure-2, fig.width=11, fig.height=5, fig.cap="A CIBER plot showing hypothetical subdeterminants of attitude (i.e. attitudinal beliefs).", warning=FALSE}
fig2 <- CIBER(dat,
...
Crutzen, R., Peters, G.-J. Y., & Noijen, J. (2017). Using Confidence Interval-Based Estimation of Relevance to select social-cognitive determinants for behaviour change interventions. Frontiers in Public Health. https://doi.org/10.3389/fpubh.2017.00165
...
Kok, G., Gottlieb, N. H., Peters, G. Y., Mullen, P. D., Parcel, G. S., Ruiter, R. A. C., … Bartholomew, L. K. (2016). A taxonomy of behavior change methods: an Intervention Mapping approach. Health Psychology Review, 10(3), 297–312. https://doi.org/10.1080/17437199.2015.1077155
